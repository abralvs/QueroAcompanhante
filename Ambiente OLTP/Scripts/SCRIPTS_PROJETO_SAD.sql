...
AS
	BEGIN
		INSERT INTO Usuario (nome,telefone,genero,cpf,dataNascimento,email,senha,descricao)
		VALUES('IGOR BRUNO','75998719582','MASCULINO','07852892590', CAST('19980524' AS DATETIME),'igorb22@live.com','0123456',''),
			  ('ABRAÃO PEREIRA ALVES','79994854123','MASCULINO','07852134569',CAST('19980901' AS DATETIME),'abraao@gmail.com','0123456',''),
			  ('JOSIELY DE OLIVEIRA','79998716573','FEMININO','07195693290',CAST('19990106' AS DATETIME),'josy@gmail.com','05487JHG','SOU ESTUDANTE DE FISICA E PRESTO ACOMPANHANMENTO ESCOLAR PARA ALUNOS ATÉ 9º ANO E ACOMPANHAMENTO INFANTIL'),
			  ('MARIA APARECIDA','79989527369','FEMININO','06932416590',CAST('19781231' AS DATETIME),'cia@gmail.com','5544asd','OLÁ, ME CHAMO APARECIDA E FAÇO ACOMPANHAMENTO INFANTIL e DOMÉSTICO, ME CONTRATE, POSSO CUIDAR DOS SEUS FILHOS'),
			  ('MARCIA SANTANA','79551166661','FEMININO','07863245980',CAST('19850801' AS DATETIME),'marciasantana@outlook.com','marcinha123','SOU ACADEMICA DE ENFERMAGEM E FAÇO ACOMPANHAMENO MÉDICO POR UM PREÇO JUSTO!'),
			  ('GILMAR RIBEIRO','75998287294','MASCULINO','04763214789',CAST('19810506' AS DATETIME),'gilmar@hotmail.com','511654S65D','EM BUSCA DE ACOMPANHANTES DOMÉSTICAS E PARA CUIDAR DOS MEUS FILHOS')
...
AS 
	BEGIN
		...
		INSERT INTO Oportunidade (descricao,idCliente,idTipoAcompanhamento,status)
		VALUES('PROCURO UMA PESSOA PARA FAZER UM ACOMPANHAMENTO MÉDICO COMIGO NO PRÓXIMO FINAL DE SEMANA 21-22/07, HORARIOS A COMBINAR',6,1,'ABERTA'),
			  ('PROCURO UMA PESSOA PARA FAZER ACOMPANHAMENTO INFANTIL PARA OS MEUS FILHOS NO PROXIMO FINAL DE SEMANA 21-22/07, HORARIOS A COMBINAR',6,2,'ABERTA'),
			  ('PROCURO UMA PESSOA PARA FAZER UM ACOMPANHAMENTO ESCOLAR COMIGO',1,5,'ABERTA')
